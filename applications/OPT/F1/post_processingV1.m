...
load('base_parameters_F1v0.mat') % batch simulation settings
...
for jj = 1:length(run_name)
    ...
    for i = 1:length(fn)
        ...
        load(['E:\wecSim\resV0_Float1\res\' fn{i} '.mat'])
...
%% save figures
% % % % % % dirFig = 'C:\Users\bbarahon\Documents\Wave\OPT\docs\Report\files\figs\F1mono\';
