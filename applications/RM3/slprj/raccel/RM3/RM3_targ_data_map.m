  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% rtB.bweohccgoh
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 98;
	
	  ;% rtB.eyb1czk053
	  section.data(17).logicalSrcIdx = 16;
	  section.data(17).dtTransOffset = 102;
	  ...
	  ;% rtB.h2og0womrq
	  section.data(25).logicalSrcIdx = 24;
	  section.data(25).dtTransOffset = 137;
	
	  ;% rtB.m3x5wslhfw
	  section.data(26).logicalSrcIdx = 25;
	  section.data(26).dtTransOffset = 143;
	  ...
	  ;% rtB.gxr43wuykr
	  section.data(29).logicalSrcIdx = 28;
	  section.data(29).dtTransOffset = 161;
	  ...
	  ;% rtB.eilvueodky
	  section.data(31).logicalSrcIdx = 30;
	  section.data(31).dtTransOffset = 173;
	  ...
	  ;% rtB.k02keb4tly
	  section.data(34).logicalSrcIdx = 33;
	  section.data(34).dtTransOffset = 187;
	
	  ;% rtB.hoc2fuxv0g
	  section.data(35).logicalSrcIdx = 34;
	  section.data(35).dtTransOffset = 191;
	
	  ;% rtB.gbda5p2r2f
	  section.data(36).logicalSrcIdx = 35;
	  section.data(36).dtTransOffset = 195;
	
	  ;% rtB.j1dwgbinuj
	  section.data(37).logicalSrcIdx = 36;
	  section.data(37).dtTransOffset = 199;
	
	  ;% rtB.hahanrb1fp
	  section.data(38).logicalSrcIdx = 37;
	  section.data(38).dtTransOffset = 203;
	  ...
	  ;% rtB.lle3duusb5
	  section.data(42).logicalSrcIdx = 41;
	  section.data(42).dtTransOffset = 365;
	
	  ;% rtB.omtni2kiws
	  section.data(43).logicalSrcIdx = 42;
	  section.data(43).dtTransOffset = 366;
	
	  ;% rtB.ovrdoaeae5
	  section.data(44).logicalSrcIdx = 43;
	  section.data(44).dtTransOffset = 367;
  ...
  targMap.checksum0 = 3952122541;
  targMap.checksum1 = 1564729906;
  targMap.checksum2 = 2904553383;
  targMap.checksum3 = 2851054102;
